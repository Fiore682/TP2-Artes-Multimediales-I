// ***** si el usuario clickea un cubo formará un autorretrato loquito, eventualmente, . . . solo si quiere ******
...
function preload() {
    for (let i = 0; i < 10; i++) { // cargo las imagenes para las texuras
        textures[i] = loadImage(`assets/img0${i}.jpg`);
    }
}
